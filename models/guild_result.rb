...
module ROGv
  class GuildResult
    ...
    def score
      @score ||= score_for_order_list(:ruled_count, :ruled_count_se,
        :ruled_count_fe, :called_count, :called_count_se, :called_count_fe)
      @score
    end

    def score_for_se
      @score_for_se ||= score_for_order_list(:ruled_count_se, :ruled_count,
        :ruled_count_fe, :called_count_se, :called_count, :called_count_fe)
      @score_for_se
    end

    def score_for_fe
      @score_for_fe ||= score_for_order_list(:ruled_count_fe, :ruled_count,
        :ruled_count_se, :called_count_fe, :called_count, :called_count_se)
      @score_for_fe
    end
